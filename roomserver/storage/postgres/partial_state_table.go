...
const insertPartialStateRoomSQL = "" +
	"INSERT INTO roomserver_partial_state_rooms (room_nid, join_event_nid, joined_via) VALUES ($1, $2, $3)" +
	" ON CONFLICT (room_nid) DO UPDATE SET join_event_nid = $2, joined_via = $3, created_at = NOW()"
